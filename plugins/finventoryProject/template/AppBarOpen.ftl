...
<#if userLogin?has_content>
  <#assign appMax = Static["org.apache.ofbiz.base.util.UtilProperties"].getPropertyAsInteger("rainbowstone", "appMax", 10)/>
         ...
         <ul  id="menu">
             ...
             <#list displayApps as display>
               ...
               <#else>
                ...
                <#if display.title == "Example" || display.title == "ExampleExt" || display.title == "FinventoryProject">
                <!-- do not display this component-->
